...
namespace SalesWebMvc.Data
{
	public class SeedingService
	{
		...
		public void Seed()
		{
			//Checks if there are instances in the table
			...
			Seller s1 = new Seller(new int(), "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0M, d1);
			Seller s2 = new Seller(new int(), "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0M, d2);
			Seller s3 = new Seller(new int(), "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0M, d1);
			Seller s4 = new Seller(new int(), "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0M, d4);
			Seller s5 = new Seller(new int(), "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0M, d3);
			Seller s6 = new Seller(new int(), "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0M, d2);
